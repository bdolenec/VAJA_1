...
with open(r'C:\Users\dolenec\Desktop\šola\5 semester\TELEKOMUNIKACIJSKI PROTOKOLI\VAJA_1\DOMAČE_NALOGE\DN3\DATA/zacetniData.json', 'w') as f:
    json.dump(zacetniData, f, indent=2)

with open(r'C:\Users\dolenec\Desktop\šola\5 semester\TELEKOMUNIKACIJSKI PROTOKOLI\VAJA_1\DOMAČE_NALOGE\DN3\DATA/updateData.json', 'w') as f:
